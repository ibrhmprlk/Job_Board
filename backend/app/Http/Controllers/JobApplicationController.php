...
public function store(Request $request, $jobId)
{
    if (! $request->user()->isJobseeker()) {
        return response()->json(['message' => 'Yetkisiz işlem
'], 403);
    }
...
// Adaya bildirim gönder  ← BUNU EKLE
...
return response()->json($application, 201);
    ...
    // İş arayan: kendi başvuralarını listele
    ...
    //İşveren: ilanına gelen başvuraları listele
